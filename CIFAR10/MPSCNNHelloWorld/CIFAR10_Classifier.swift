...
class CIFAR10_Classifier : NeuralNetwork {
    ...
    init(device: MTLDevice, inflightBuffers: Int) {
        ...
        pool = maxPooling(device: device, kernel: (2,2), stride: (2,2))
        fc1 = dense(device: device, shape: (4,4), inChannels: 64, fanOut: 128, activation: relu, name: "fc1")
    ...
    func encode(commandBuffer: MTLCommandBuffer, texture: MTLTexture, inflightIndex: Int) {
        ...
        let conv1Img = MPSTemporaryImage(commandBuffer: commandBuffer, imageDescriptor: c1id)
        ...
        let conv2Img = MPSTemporaryImage(commandBuffer: commandBuffer, imageDescriptor: c2id)
        ...
        let conv3Img = MPSTemporaryImage(commandBuffer: commandBuffer, imageDescriptor: c3id)
        ...
        pool.encode(commandBuffer: commandBuffer, sourceImage: conv3Img, destinationImage: p3Img)
    ...
    //expected result
    //tensor([[8.3575e-01, 7.0725e-02, 6.0735e-02, 1.7954e-02, 1.0604e-02, 4.1041e-03,
    //3.2909e-05, 3.2909e-05, 3.2909e-05, 3.2909e-05]])
