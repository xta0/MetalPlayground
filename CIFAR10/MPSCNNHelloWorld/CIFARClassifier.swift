...
class CIFARClassifier {
    ...
    //network structure
    var conv1,conv2,conv3 : CIFAR_ConvLayer
    var pool: MPSCNNPoolingMax
//    var dropout: MPSCNNDropout
    var relu: MPSCNNNeuronReLU
    var fc1,fc2: CIFAR_FCLayer
...
//        dropout = MPSCNNDropout(device: device, keepProbability: 0.2, seed: 1, maskStrideInPixels: MTLSize(width: 1, height: 1, depth: 1))
        relu = MPSCNNNeuronReLU(device: device, a: 0)
        softmax = MPSCNNLogSoftMax(device: device)
        conv1 = CIFAR_ConvLayer(kernelWidth: 3,
                                kernelHeight: 3,
        ...
        conv2 = CIFAR_ConvLayer(kernelWidth: 3,
                                kernelHeight: 3,
        ...
        conv3 = CIFAR_ConvLayer(kernelWidth: 3,
                                kernelHeight: 3,
        ...
        fc1 = CIFAR_FCLayer(kernelWidth: 1,
                            kernelHeight: 1,
        ...
        fc2 = CIFAR_FCLayer(kernelWidth: 1,
                            kernelHeight: 1,
